  ...
  return (
    <section className='h-auto flex  bg-shades-1 z-20 '>
      <div className='lg:p-20 p-5 flex flex-col w-full'>
        ...
        <p className='text-2xl lg:text-8xl font1 z-10 text-shades-8'>Projects</p>
        ...
        <div className='lg:px-10 bg-red-00 flex flex-col lg:flex-row items-center justify-center mt-10 mb-10 font2 rounded-3xl gap-5 border border-shades-3 p-[5px]'>
                    ...
                    <div className='flex items-center justify-between lg:p-10 p-5 border m-1 border-shades-6 rounded-3xl'>
                        <div className='flex flex-col'>
                            ...
                            <div className='flex mt-2 text-sm opacity-80'>
                                <div className='b bg-waka_total rounded text-font text-white lg:text-[16px] pl-1 pr-1 shadow-sm'><p className='d drop-shadow-md'>total:</p></div>
            ...
            <div className='lg:w-2/5 h-full flex items-end justify-end'>
                <div className='w-full h-auto bg-shades-7 border border-shades-8 rounded-3xl'>
                  ...
                  <a className='lg:w-1/2 rounded-3xl bg-shades-8 h-full flex items-center justify-center text-shades-1 p-5 border border-shades-7 text-xl' href="https://github.com/kopildas/furniture">
                        <div >Github link</div></a>
                      <div></div>
                      <a className='lg:w-1/2 rounded-3xl bg-shades-8 h-full flex items-center justify-center text-shades-1 p-5 border border-shades-7 text-xl' href="https://woodhy.vercel.app/">
